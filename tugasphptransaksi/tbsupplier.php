...
<form id="saveformsupplier" method="POST">
	<h1>Form Supplier</h1>
	<table border="0">
		<tr>
			<td>Kode Supplier</td>
			<td>:</td>
			<td><input type="text" name="kodesup" id="kodesup"></td>
		</tr>
		<tr>
			<td>Nama</td>
			<td>:</td>
...
<div id="tabelsupplier" class="my-2" style="max-height: 300px;overflow-y: auto;"></div>
<br>
